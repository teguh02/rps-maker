...
import { StructuredList, RowActions } from './StructuredList'
import type { StructuredItem } from './StructuredList'
...
export function Editor({ project, onUpdate, onSave, onExport, onOpenAISettings, onGoHome, onOpenGuide, onPreview, autoSaveActive, lastAutoSaveAt, showToast }: EditorProps) {
  ...
  // RowActions and StructuredList are imported from ./StructuredList
